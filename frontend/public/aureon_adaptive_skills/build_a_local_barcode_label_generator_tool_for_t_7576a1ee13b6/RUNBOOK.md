...
- preview: /aureon_adaptive_skills/build_a_local_barcode_label_generator_tool_for_t_7576a1ee13b6/index.html

## Run

```powershell
.\.venv\Scripts\python.exe C:\Users\user\aureon-trading\frontend\public\aureon_adaptive_skills\build_a_local_barcode_label_generator_tool_for_t_7576a1ee13b6\tool.py
```
