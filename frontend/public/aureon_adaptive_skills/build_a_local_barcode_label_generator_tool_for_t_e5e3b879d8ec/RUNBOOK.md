...
- preview: /aureon_adaptive_skills/build_a_local_barcode_label_generator_tool_for_t_e5e3b879d8ec/index.html

## Run

```powershell
.\.venv\Scripts\python.exe C:\Users\user\aureon-trading\frontend\public\aureon_adaptive_skills\build_a_local_barcode_label_generator_tool_for_t_e5e3b879d8ec\tool.py
```
