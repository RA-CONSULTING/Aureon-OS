...
- preview: /aureon_adaptive_skills/build_a_local_barcode_label_generator_tool_for_t_e9bbb38ea233/index.html

## Run

```powershell
.\.venv\Scripts\python.exe C:\Users\user\aureon-trading\frontend\public\aureon_adaptive_skills\build_a_local_barcode_label_generator_tool_for_t_e9bbb38ea233\tool.py
```
