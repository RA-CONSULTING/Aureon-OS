...
| Public navigation manifests | `frontend/public/aureon_repo_sitemap.json`, `frontend/public/aureon_end_user_access_map.json` | Tracked, secret-free access contracts for UI/SaaS shells. |
