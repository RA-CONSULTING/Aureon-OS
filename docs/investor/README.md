...
| Public GitHub reader | Setup, architecture, module map, research history, contribution route, and preserved archive. | Start with [`../INDEX.md`](../INDEX.md), [`../../QUICK_START.md`](../../QUICK_START.md), and [`../../RUNNING.md`](../../RUNNING.md). |
...
3. Review architecture in [`../../SYSTEM_OVERVIEW.md`](../../SYSTEM_OVERVIEW.md)
   and [`../../DATA_FLOW.md`](../../DATA_FLOW.md).
4. Review claims through [`../CLAIMS_AND_EVIDENCE.md`](../CLAIMS_AND_EVIDENCE.md)
   and audit/proof documents.
5. Review the Gary/Aureon evidence inventory under
   [`../../data/research/grants/`](../../data/research/grants/).
6. Use the archived README only for project history:
