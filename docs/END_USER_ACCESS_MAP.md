...
| Repo navigation | Browse all systems and how they relate. | [`REPO_SITEMAP.md`](REPO_SITEMAP.md), [`INDEX.md`](INDEX.md) | `docs/`, root docs, `frontend/public/` | `frontend/public/aureon_repo_sitemap.json` | Keep generated counts current after major moves. |
